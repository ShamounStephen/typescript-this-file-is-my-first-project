...
// console.log (quote);
// //question no.5
// let personName = "Vicky Smith";
// console.log("Vicky\nSmith");
// console.log(personName);
// let secondName ="Jimmy Wind" ;
// console.log("Jimmy\tWind");
...
//  //My Name: [Shamoun Stephen]
//  //Date: [11.11.2023]
//  //Guest List
//  let dinnerGuests = ['Sarah', 'Mama', 'Rose'];
//  //Inviting more 
// let additionalGuests = ['Peter', 'Emmanuel', 'John'];
...
// //question no.9
// let names= ['Ahsan', 'Noel', 'Haroon'];
// for (let name of names) {
//     console.log(name);
// }
// //question no.10
// let names =['Rana','Stephen','Osama' ];
// for (let name of names ) {
//     console.log(name);
// }
//  //greetings to all
...
// }
// //question no.12
// let DinnerGuest = ['Sarah', 'Mama','Rose'];
...
// }
// //question no.25
// let userNames = ['Admin', 'Ayesha', 'Taimoor', 'Zohaib', 'Marline', 'Huda','Sarah'];
...
// //     return city + "," + country;
// // }
// // const location = cityCountry("karachi", "pakistan");
